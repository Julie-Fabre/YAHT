...
probes_list = arrayfun(@(x) sprintf('<HTML><FONT color="#%02x%02x%02x"><b>Probe %d</b></Font>', ...
                                    round(255*gui_data.probe_color(x, 1)), ...
                                    round(255*gui_data.probe_color(x, 2)), ...
                                    round(255*gui_data.probe_color(x, 3)), ...
                                    x), ...
                        1:gui_data.n_probes, 'UniformOutput', false);
