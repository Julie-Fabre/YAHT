...
Adjust the paths in `ya_histologyMain_template` an run through the sections to get started. So far, this pipeline has not been widely used and tested, and the documentation is not complete. You will likely run into some questions/issues and incompatibilities. Please contact me at julie[dot]mfabre[at]gmail[dot]com if that's the case. I'm happy to help! 
