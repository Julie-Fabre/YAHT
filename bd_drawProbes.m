...
if size(probe_ccf,1) > gui_data.n_probes
    ...
    gui_data.probe_points_histology(:, size(probe_ccf,1)) = cell(length(gui_data.slice_im), 1);
    gui_data.probe_lines(size(probe_ccf,1)) = gobjects(1, 1);
    gui_data.probe_fit_lines(size(probe_ccf,1)) = gobjects(1, 1);
